...
public class CuciBasahActivity extends AppCompatActivity {
    ...
    int hargaKaos = 5000, hargaCelana = 7000, hargaJaket = 10000, hargaSprei = 60000, hargaKarpet = 150000;
    ...
    private void setInitLayout() {
        ...
        tvInfo.setText("Cuci basah adalah proses pencucian pakaian biasa menggunakan air dan deterjen");
    }
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItem == 0 || totalHarga == 0) {
                ...
                Toast.makeText(CuciBasahActivity.this, "Pesanan Anda sedang diproses, silahkan cek di menu riwayat", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
