...
import com.example.project2.viewmodel.LaundryViewModel;
...
public class HistoryActivity extends AppCompatActivity implements HistoryAdapter.HistoryAdapterCallback {
    ...
    private void setStatusbar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            getWindow().getDecorView().setSystemUiVisibility(RecyclerView.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        }
    ...
    private void setViewModel() {
        laundryViewModel = new ViewModelProvider(this).get(LaundryViewModel.class);
