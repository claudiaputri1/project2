...
public class DryCleanActivity extends AppCompatActivity {
    ...
    int hargaKaos = 7000, hargaCelana = 10000, hargaJaket = 12000, hargaSprei = 75000, hargaKarpet = 200000;
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItem == 0 || totalHarga == 0) {
                ...
                Toast.makeText(DryCleanActivity.this, "Pesanan Anda sedang diproses, silahkan cek di menu riwayat", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
