...
public class PremiumWashActivity extends AppCompatActivity {
    ...
    int hargaKaos = 10000, hargaCelana = 15000, hargaJaket = 17000, hargaSprei = 100000, hargaKarpet = 250000;
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItem == 0 || totalHarga == 0) {
                ...
                Toast.makeText(PremiumWashActivity.this, "Pesanan Anda sedang diproses, silahkan cek di menu riwayat", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
